...
@section('content') 
    ...
    <div class="row tm-row">
                <article class="col-12 col-md-6 tm-post">
                    ...
                    <a href="post.html" class="effect-lily tm-post-link tm-pt-60">
                        <div class="tm-post-link-inner">
                            <img src="img/malang.jpg" alt="Image" class="img-fluid">                            
                        </div>
                        <span class="position-absolute tm-new-badge">New</span>
                        <h2 class="tm-pt-30 tm-color-primary tm-post-title">Balai Kota Malang</h2>
                    </a>                    
                    <p class="tm-pt-30">
                    Balai Kota Malang adalah salah satu bangunan peninggalan pemerintah kolonial Hindia Belanda. 
                    Bangunan ini terletak di lingkaran jalan Tugu Kota Malang dengan arsitektur kolonial Belanda
                    </p>
                ...
                <article class="col-12 col-md-6 tm-post">
                    ...
                    <a href="post.html" class="effect-lily tm-post-link tm-pt-60">
                        <div class=" tm-post-link-inner">
                            <img src="img/batu.jpg" alt="Image" class="img-fluid">                            
                        </div>
                        <span class="position-absolute tm-new-badge">New</span>
                        <h2 class="tm-pt-30 tm-color-primary tm-post-title">Alun-Alun Kota Batu</h2>
                    </a>                    
                    <p class="tm-pt-30">
                        <a rel="nofollow" href="https://templatemo.com/tm-553-xtra-blog" target="_blank">Alun-alun Kota Batu</a> ini selain berfungsi sebagai taman kota juga banyak 
                        di kunjungi wisatawan untuk berekreasi. Hal ini karena fasilitas dan wahana yang ada di taman cukup lengkap. Mulai dari wahana permainan sampai wisata kuliner bisa dilakukan di sini.
                    </p>
                    <div class="d-flex justify-content-between tm-pt-45">
